# TODO: (우선)
#   0. 디버깅: 솔루션 여러개 만들어도 똑같은 배치만 여러개 나옴
#   1. Visualizer 구현
...
#
#     s = total_allocated_processing_power + total_allocated_bandwidth + total_allocated_delay_factor
#     print(total_allocated_processing_power, total_allocated_bandwidth, total_allocated_delay_factor, 'SUM =', s)
#     return ()
#
#
